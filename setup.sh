...
echo "mv /opt /opt_sic"
echo "hier fehlt noch was vom laubi -> der planmaessige restore beim first_boot"
echo "--> Wir brauchen ein Script zum: erkennen - first docker container start"
echo "                                          - /opt/loxberry ist symlink"
echo "                                          - Services anhalten"
echo "                                          - Symlink löschen"
echo "                                          - mv /opt_sic/loxberry /opt/"
